...
namespace Payments\PayPal\Controller\Express\AbstractExpress;

/**
 * Class PlaceOrder
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class PlaceOrder extends \Payments\PayPal\Controller\Express\AbstractExpress
{
    /**
     * Submit the order
     *
    ...
    public function execute()
    {
        try {
            ...
            $this->loggerModel->critical("Unable to place PayPal Order: " . $e->getMessage(), ['stacktrace' => $e->getTraceAsString()]);

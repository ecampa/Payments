...
class DmProcessor implements \Payments\Core\DM\TransactionProcessorInterface
{
    ...
    {
        $orderSetupTransactionId = $payment->getAdditionalInformation(\Payments\PayPal\Model\Express\Checkout::PAYMENT_INFO_TRANSPORT_ORDER_SETUP_TXN_ID);
    ...
    private function isValidResponse($response)
    {
        return $response
            ...
            && $response['decision'] == \Payments\Core\Cron\DecisionManagerReport::DM_ACCEPT

...
class Config extends \Payments\Core\Model\AbstractGatewayConfig
{
    ...
    const CODE_CREDIT = 'payments_paypal_credit';
    const CODE_VAULT = 'payments_paypal_vault';
    ...
    {
        return $this->getPayPalRedirectType() == \Payments\PayPal\Model\Source\RedirectionType::IN_CONTEXT;
    }

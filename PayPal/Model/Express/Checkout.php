...
namespace Payments\PayPal\Model\Express;

use Payments\PayPal\Helper\RequestDataBuilder;
use Payments\PayPal\Model\Config;
use Payments\PayPal\Model\Info;
use Payments\PayPal\Model\Payment;
...
class Checkout
{
     ...
     * @var string
     */
    protected $_methodType = \Payments\PayPal\Model\Config::CODE;
    ...
    public function __construct(
        ...
        \Payments\PayPal\Model\Info $paypalInfo,
        ...
        \Payments\PayPal\Service\GatewaySoapApi $api,

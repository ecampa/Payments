<?php
namespace Payments\ECheck\Gateway\Request;
...
use Payments\ECheck\Gateway\Helper\SubjectReader;
...
abstract class AbstractRequest
{
    ...
    */
    ...
    protected function buildAuthNodeRequest($merchantID, $merchantReferenceCode)
    {
        ...
        $this->config->setMethodCode(\Payments\Core\Model\Config::CODE);
        $developerId = $this->config->getDeveloperId();
        if (!empty($developerId) || $developerId !== null) {
            $request->developerId = $developerId;
        }
        $this->config->setMethodCode(\Payments\ECheck\Model\Ui\ConfigProvider::CODE);

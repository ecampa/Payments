<?php
namespace Payments\ECheck\Gateway\Command;
...
class GetNotificationOfChangesReportCommand implements \Magento\Payment\Gateway\CommandInterface
{
    ...
    /**
     * @var \Payments\Core\Gateway\Response\MapperInterface
     */
    private $mapper;
    ...
    public function __construct(
        ...
        \Payments\Core\Gateway\Response\MapperInterface $mapper,
    ...
    public function execute(array $commandSubject)
    {
        ...
        } catch (\Payments\Core\Gateway\Validator\NotFoundException $e) {

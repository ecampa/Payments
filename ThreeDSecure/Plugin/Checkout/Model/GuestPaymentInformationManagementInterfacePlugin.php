...
namespace Payments\ThreeDSecure\Plugin\Checkout\Model;
...
class GuestPaymentInformationManagementInterfacePlugin
{
    ...
    public function aroundSavePaymentInformationAndPlaceOrder(
        ...
        try {
            ...
            if (!$e->getPrevious() instanceof \Payments\ThreeDSecure\Gateway\PaEnrolledException) {
                throw $e;
            }
            ...
            $quote->getPayment()->setAdditionalInformation(
                \Payments\ThreeDSecure\Gateway\Validator\PaEnrolledValidator::KEY_PAYER_AUTH_ENROLL_TRANSACTION_ID,

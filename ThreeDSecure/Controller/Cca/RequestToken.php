<?php
namespace Payments\ThreeDSecure\Controller\Cca;
...
class RequestToken extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $data = [
                PaymentInterface::KEY_METHOD => $payment->getMethod() ?? \Payments\SecureAcceptance\Model\Ui\ConfigProvider::CODE
            ];
            ...
            $tokenResult = $this->commandManager->executeByCode(
                \Payments\ThreeDSecure\Gateway\Command\Cca\CreateToken::COMMAND_NAME,
                $quote->getPayment(),
                $params
            );

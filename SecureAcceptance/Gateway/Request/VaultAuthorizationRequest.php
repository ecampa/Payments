...
class VaultAuthorizationRequest extends \Payments\SecureAcceptance\Gateway\Request\AbstractRequest implements BuilderInterface
{
    ...
    public function __construct(
        ...
        \Payments\SecureAcceptance\Helper\Vault $vault,
        $isAdmin = false
    ) {

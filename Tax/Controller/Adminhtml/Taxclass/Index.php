...
class Index extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Payments_Tax::tax_class');
    }
    ...
    protected function _setPageData()
    {
        ...
        $resultPage->setActiveMenu('Payments_Tax::tax_class');
        $resultPage->getConfig()->getTitle()->prepend((__('Tax Classes')));

        //Add bread crumb
        $resultPage->addBreadcrumb(__('Payments'), __('Payments'));
        $resultPage->addBreadcrumb(__('Payments'), __('Tax Classes'));

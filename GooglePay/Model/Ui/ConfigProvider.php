<?php
namespace Payments\GooglePay\Model\Ui;
...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    /**
     * @var \Payments\GooglePay\Model\CardTypeMap
     */
    private $cardTypeMap;
    /**
     ...
     * Constructor
     *
     * @param \Payments\GooglePay\Gateway\Config\Config $config
     * @param ResolverInterface $localeResolver
     * @param \Payments\GooglePay\Model\CardTypeMap $cardTypeMap
    ...
    public function __construct(
        ...
        \Payments\GooglePay\Model\CardTypeMap $cardTypeMap,

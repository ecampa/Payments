<?php
namespace Payments\GooglePay\Controller\Index;
...
class Place extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Payments\GooglePay\Model\AddressConverter
     */
    ...
    public function __construct(
        ...
        \Payments\GooglePay\Model\AddressConverter $addressConverter,
    ...
    public function execute()
    {
        ...
        try {
            ...
            $quote->setPaymentMethod(\Payments\GooglePay\Model\Ui\ConfigProvider::CODE);
            $quote->setInventoryProcessed(false);

            $quote->getPayment()->importData(
                [
                    'method' => \Payments\GooglePay\Model\Ui\ConfigProvider::CODE,

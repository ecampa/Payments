define([
        ...
        return Component.extend({
            ...
            getPaymentDataRequest: function () {
                ...
                $.post(
                    urlBuilder.build('paymentsgooglepay/index/request'),
                    {
            ...
            paymentDataChangedHandler: function (paymentData) {
                ...
                $.post(urlBuilder.build('paymentsgooglepay/index/shipping'),
                    requestData
                    ...
                    $.post(urlBuilder.build('paymentsgooglepay/index/request'),
                        {
                            form_key: $.cookie('form_key')
                        }
            ...
            processPayment: function (paymentData) {
                ...
                $.post(urlBuilder.build('paymentsgooglepay/index/place'),
                    {
                        form_key: $.cookie('form_key'),

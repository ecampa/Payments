<?php
namespace Payments\GooglePay\Block;

use Payments\GooglePay\Gateway\Config\Config;
    ...
    implements \Magento\Catalog\Block\ShortcutInterface
{
    ...
    protected function shouldRender()
    {
        return $this->method->isAvailable($this->checkoutSession->getQuote())
            && $this->method->getConfigData(\Payments\GooglePay\Gateway\Config\Config::KEY_ACTIVE)
            && $this->isButtonEnabled();
    }

    private function isButtonEnabled()
    {
        return $this->isMiniCart && $this->method->getConfigData(\Payments\GooglePay\Gateway\Config\Config::KEY_BUTTON_SHOW_MINICART)
            || !$this->isMiniCart && $this->method->getConfigData(\Payments\GooglePay\Gateway\Config\Config::KEY_BUTTON_SHOW_PDP);
    }
    ...
    public function getJsonConfig()
    {
        ...
        $config = array_merge(
            ...
            $this->configProvider->getConfig()['payment'][\Payments\GooglePay\Model\Ui\ConfigProvider::CODE]
        );

define(
    [
        ...
        'visaSdk',
        'Payments_VisaCheckout/js/action/set-payment-method',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                active: false,
                template: 'Payments_VisaCheckout/payment/form',
                code: 'payments_visa',
            ...
            getTitle: function () {
                return window.checkoutConfig.payment['payments_visa'].title;
            },
            getApiKey: function () {
                return window.checkoutConfig.payment['payments_visa'].api_key;
            },
            getPlaceOrderUrl: function () {
                return window.checkoutConfig.payment['payments_visa'].placeOrderUrl;
            },
            getData: function () {
                var data = {
            ...
            getButtonUrl: function () {
                return window.checkoutConfig.payment['payments_visa'].buttonUrl;
            },
            ...
            placeOrder: function (callId) {
                ...
                if (additionalValidators.validate()) {
                    ...
                    var agreements = $(".payment-method-payments_visa .checkout-agreements-block").find('input');

...
use Payments\KlarnaFinancial\Gateway\Validator\ResponseCodeValidator;
use Payments\KlarnaFinancial\Helper\RequestDataBuilder;
use Payments\KlarnaFinancial\Model\Ui\ConfigProvider;
...
class PlaceOrder extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $quote->setPaymentMethod(\Payments\KlarnaFinancial\Model\Ui\ConfigProvider::CODE);
        $quote->setInventoryProcessed(false);

        // Set Sales Order Payment
        $quote->getPayment()->importData(['method' => \Payments\KlarnaFinancial\Model\Ui\ConfigProvider::CODE]);

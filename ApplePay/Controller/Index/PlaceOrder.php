<?php
namespace Payments\ApplePay\Controller\Index;
...
class PlaceOrder extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $quote->setPaymentMethod(\Payments\ApplePay\Model\Ui\ConfigProvider::APPLEPAY_CODE);
        $quote->setInventoryProcessed(false);

        // Set Sales Order Payment
        $quote->getPayment()->importData(['method' => \Payments\ApplePay\Model\Ui\ConfigProvider::APPLEPAY_CODE]);

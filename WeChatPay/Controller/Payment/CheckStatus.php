<?php
namespace Payments\WeChatPay\Controller\Payment;
...
class CheckStatus extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Payments\WeChatPay\Model\StatusCheckMessageMapper
     */
     ...
     * @param \Payments\WeChatPay\Model\StatusCheckMessageMapper $statusCheckMessageMapper
    ...
    public function __construct(
        ...
        \Payments\WeChatPay\Model\StatusCheckMessageMapper $statusCheckMessageMapper,
    ...
    private function getMessage($wcpStatus)
    {
        ...
        if ($wcpStatus !== \Payments\WeChatPay\Gateway\Config\Config::PAYMENT_STATUS_PENDING) {
            return $message;
        }

...
use Exception;
use Payments\Core\Gateway\Http\Client\Rest\RequestSigner;
...
class Rest implements ClientInterface
{
    ...
    public function __construct(
        ...
        \Payments\Core\Gateway\Http\Client\Rest\RequestSigner $requestSigner,
     ...
     * @return \Payments\Core\Gateway\Http\Client\Rest
     */

<?php
namespace Payments\Core\Helper;
...
class ReasonCodeHandler
{
    ...
    private static $messages = [
        ...
        200 => "Soft Decline - The authorization request was approved by the issuing bank but declined by gateway because it did not pass the Address Verification Service (AVS) check.",
        ...
        230 => "Soft Decline - The authorization request was approved by the issuing bank but declined by gateway because it did not pass the card verification number (CVN) check.",
        ...
        234 => "Decline - There is a problem with your gateway merchant configuration.",
        ...
        520 => "Soft Decline - The authorization request was approved by the issuing bank but declined by gateway based on your Smart Authorization settings.",

...
abstract class AbstractConnection
{
    ...
    const IS_TEST_MODE_CONFIG_PATH = 'payment/payments_sa/use_test_wsdl';
    const TEST_WSDL_PATH           = 'payment/payments_sa/path_to_test_wsdl';
    const LIVE_WSDL_PATH           = 'payment/payments_sa/path_to_wsdl';
    const MERCHANT_ID_PATH         = 'payment/payments_sa/merchant_id';
    const TRANSACTION_KEY_PATH     = 'payment/payments_sa/transaction_key';
...
//                $client->addSoapInputHeader($header);
    ...
    {
        $this->merchantId = $this->config->getValue('payment/payments_bank_transfer/'.$bankTransferPaymentMethod.'_merchant_id', $this->storeScope);
        $this->transactionKey = $this->config->getValue('payment/payments_bank_transfer/'.$bankTransferPaymentMethod.'_transaction_key', $this->storeScope);
    }

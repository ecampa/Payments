...
namespace Payments\Core\Controller\Adminhtml\Action;


use Payments\Core\Cron\DecisionManagerReport;
...
class DecisionManagerOnDemand extends Action
{
    ...
    public function __construct(
        Context $context,
        \Payments\Core\Cron\DecisionManagerReport $decisionManagerReport,

...
class Success extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $quote->setPaymentMethod('payments_bank_transfer');
            $quote->setInventoryProcessed(false);
            $quote->save();
            $quote->getPayment()->setAdditionalInformation('gateway_response', (array)$responses);
            $quote->getPayment()->setTransactionId($responses->apSaleReply->processorTransactionID);
            
            $quote->getPayment()->setMethod('payments_bank_transfer');

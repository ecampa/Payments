...
use Payments\BankTransfer\Service\BancontactSoap;
...
class Bancontact extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    const CODE = 'payments_bank_transfer_bancontact';
    ...
    public function __construct(
        ...
        \Payments\BankTransfer\Service\BancontactSoap $gatewayAPI,
    ...
    private function isCurrencyAvailable()
    {
        return (in_array(
            ...
            explode(',', $this->_scopeConfig->getValue(
                "payment/payments_bank_transfer/bancontact_currency",
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            ))
        ));
    }

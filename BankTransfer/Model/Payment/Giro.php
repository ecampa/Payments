 ...
 * Class Config
 */
class Giro extends \Magento\Payment\Model\Method\AbstractMethod
{
    
    const CODE = 'payments_bank_transfer_giro';
    ...
    public function isActive($storeId = null)
    {
        return $this->isCurrencyAvailable() && (bool)(int)$this->_scopeConfig->getValue(
            "payment/payments_bank_transfer/giro_active",
    ...
    private function isCurrencyAvailable()
    {
        return (in_array(
            ...
            explode(',', $this->_scopeConfig->getValue(
                "payment/payments_bank_transfer/giro_currency",
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            ))
        ));
    }
